# Generated by Powerlevel10k configuration wizard on 2022-09-19 at 14:37 +07.
...
function prompt_count_subdir() {
local subdir=$(find . -mindepth 1 -maxdepth 1 -type d | wc -l)

if [[ subdir > 0 ]] then
    local state=NOT_EMPTY
else
    local state=EMPTY
fi

p10k segment -s ${state} -f '#ffff00' -t "${subdir} subdirectories"
}
